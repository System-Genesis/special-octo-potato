...
export class Role extends AggregateRoot {
    ...
    private constructor(roleId: RoleId, props: RoleState, opts: CreateOpts) {
        super(roleId, opts);
        const { source, directGroup, jobTitle = '', digitalIdentityUniqueId, clearance: clearance, createdAt } = props;
        this._source = source;
    ...
    public connectDigitalIdentity(
        ...
        if (!!this._digitalIdentityUniqueId) {
            return err(AlreadyConnectedToDigitalIdentity.create(this.id.toString(), this._digitalIdentityUniqueId.toString()));
        }
    ...
    public static createRole(roleId: RoleId, groupId: GroupId, props: Omit<RoleState, 'directGroup' | 'digitalIdentityUniqueId'>) {
