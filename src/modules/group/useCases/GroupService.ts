...
export class GroupService {
    ...
    async createGroup(
        ...
        Result<GroupResultDTO, AppError.ValueValidationError | AppError.ResourceNotFound | AppError.RetryableConflictError | DuplicateChildrenError>
    > {
    ...
    ): Promise<Result<void, AppError.ResourceNotFound | AppError.RetryableConflictError | DuplicateChildrenError | TreeCycleError>> {
