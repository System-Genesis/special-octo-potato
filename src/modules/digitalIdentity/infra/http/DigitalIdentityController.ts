...
import { CreateDigitalIdentityDTO, joiSchema as CreateDigitalIdentitySchema } from '../../useCases/dtos/CreateDigitalIdentityDTO';
import { joiSchema as DeleteDigitalIdentitySchema } from '../../useCases/dtos/DeleteDigitalIdentityDTO';
import { UpdateDigitalIdentityDTO, joiSchema as UpdateDigitalIdentitySchema } from '../../useCases/dtos/UpdateDigitalIdentityDTO';

export class DigitalIdentityController {
    constructor(private _diService: DigitalIdentityService) {}
